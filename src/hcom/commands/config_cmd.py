...
Merged with launch-time cli args (launch args win on conflict).
""",
    "HCOM_RELAY": """HCOM_RELAY - MQTT broker URL
...
""",
    "HCOM_RELAY_ID": """HCOM_RELAY_ID - Shared UUID for relay group
...
""",
    "HCOM_RELAY_TOKEN": """HCOM_RELAY_TOKEN - Auth token for MQTT broker
...
def cmd_config(argv: list[str], *, ctx: CommandContext | None = None) -> int:
    ...
    from ..core.paths import hcom_path, CONFIG_TOML

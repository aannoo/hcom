...
def _config_files_hint() -> str:
    """Resolved paths for config help."""
    from ..core.paths import hcom_path, CONFIG_TOML, ENV_FILE
...
COMMAND_HELP: dict[str, list[HelpEntry]] = {
    ...
    "config": [
        ...
        lambda: ("", f"Files: {_config_files_hint()}"),
...
KNOWN_FLAGS: dict[str, set[str]] = {
    ...
    "config": _GLOBAL_FLAGS | {"--json", "--edit", "--reset", "-i", "--info", "--setup"},
    "reset": _GLOBAL_FLAGS,
    "relay": _GLOBAL_FLAGS | {"--broker", "--password"},
